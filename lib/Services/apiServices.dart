...
class ApiServices {
  ...
  Future<dynamic> postFormData({required String apiUrl,
  ...
  Future<dynamic> postRawData({
    ...
    try {
      ...
      var response = await http
          .post(uri, body: jsonEncode(payloadObj), headers: headers)
          .timeout(const Duration(seconds: timeOutDuration));
  ...
  Future<dynamic> uploadFile({required String endPoint,
    required bool isTokened,
