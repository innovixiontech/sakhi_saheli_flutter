...
class UserSimplePreferences {
  ...
  static const _securityToken = 'securityToken';
...
// ----------------Customer DOB ---------------- //
  ...
  // ----------------Customer DOB ---------------- //
  static Future setSecurityToken(String sToken) async {
    //  SharedPreferences _preferences = await SharedPreferences.getInstance();
    return await _preferences.setString(_securityToken, sToken);
  }

  static String? getSecurityToken() => _preferences.getString(_securityToken);
  static Future clearSecurityToken() async {
    //  SharedPreferences _preferences = await SharedPreferences.getInstance();
    return await _preferences.remove(_securityToken);
  }
